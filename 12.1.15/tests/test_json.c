...
main (void)
{
  ...
  jb_json_object_set_float_with_default (object, JSON_X,
                                         (JBDOUBLE) 1., (JBDOUBLE) 0.);
  jb_json_object_set_int_with_default (object, JSON_I, 1, 0);
  jb_json_object_set_time_with_default (object, JSON_T,
                                        (JBDOUBLE) 1., (JBDOUBLE) 0.);
  ...
  x = jb_json_object_get_float_with_default (object, JSON_X,
                                             &e1, (JBDOUBLE) 0.);
